...
protocol CrownsPlayViewProtocol: AnyObject {
    
}

final class CrownsPlayViewController: UIViewController, CrownsPlayViewProtocol{
    ...
    var presenter: CrownsPlayPresenter?
