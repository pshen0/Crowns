//
//  QueensLearningViewController.swift
//  Crowns
//
...
final class QueensLearningViewController: UIViewController{
    ...
    private let interactor: QueensLearningBusinessLogic
    
    init(interactor: QueensLearningBusinessLogic) {
    ...
    @objc private func backButtonTapped() {
        interactor.backButtonTapped(QueensLearningModel.RouteBack.Request())
    }
